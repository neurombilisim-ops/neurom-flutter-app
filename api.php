...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
		...
		Route::post('profile/update-email', 'App\Http\Controllers\Api\V2\ProfileController@updateEmail')->middleware('auth:sanctum');
	...
	// PayTR Routes
	Route::any('paytr/init', 'App\Http\Controllers\Api\V2\PayTRController@init')->name('api.paytr.init');
	Route::any('paytr/callback', 'App\Http\Controllers\Api\V2\PayTRController@callback')->name('api.paytr.callback');
	Route::any('paytr/success', 'App\Http\Controllers\Api\V2\PayTRController@success')->name('api.paytr.success');
	Route::any('paytr/fail', 'App\Http\Controllers\Api\V2\PayTRController@fail')->name('api.paytr.fail');
