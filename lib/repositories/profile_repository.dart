...
import 'package:neurom_bilisim_store/data_model/profile_image_update_response.dart';
import 'package:neurom_bilisim_store/data_model/user_info_response.dart';
import 'dart:convert';
import 'package:neurom_bilisim_store/data_model/profile_counters_response.dart';
import 'package:neurom_bilisim_store/data_model/profile_update_response.dart';
import 'package:neurom_bilisim_store/data_model/device_token_update_response.dart';
import 'package:neurom_bilisim_store/data_model/phone_email_availability_response.dart';
...
class ProfileRepository {
  ...
  Future<dynamic> getEmailUpdateResponse({required String post_body}) async {
    String url = ("${AppConfig.BASE_URL}/profile/update-email");
    final response = await ApiRequest.post(
        url: url,
        headers: {
          "Content-Type": "application/json",
  ...
  Future<dynamic> sendEmailVerificationCode() async {
    String url = ("${AppConfig.BASE_URL}/profile/send-verification-code");
    final response = await ApiRequest.get(
        url: url,
        headers: {
          "Content-Type": "application/json",
