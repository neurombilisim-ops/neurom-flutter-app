...
import 'package:neurom_bilisim_store/helpers/reg_ex_inpur_formatter.dart';
...
import 'package:neurom_bilisim_store/repositories/wallet_repository.dart';
  ...
  void initState() {
    ...
    _mainScrollController.addListener(() {
      if (_mainScrollController.position.pixels >=
          _mainScrollController.position.maxScrollExtent - 100) { // 100px önceden yükle
        if (!_showRechageLoadingContainer) { // Çoklu yükleme önle
          _rechargePage++;
