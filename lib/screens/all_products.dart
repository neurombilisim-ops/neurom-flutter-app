    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          // API'den gelen filtrelenmiş ürünleri al
          List<dynamic> filteredProducts = response.products ?? [];
          
          _originalProducts.addAll(filteredProducts);
