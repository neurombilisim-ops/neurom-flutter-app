...
class DetailedProduct {
  ...
  factory DetailedProduct.fromJson(Map<String, dynamic> json) =>
      DetailedProduct(
        ...
        unit: json["unit"],
        rating: json["rating"] != null ? json["rating"].toInt() : 0,
        rating_count: json["rating_count"],
        earn_point: json["earn_point"] != null ? json["earn_point"].toInt() : 0,
        ...
        wholesale: json["wholesale"] != null 
            ? List<Wholesale>.from(json["wholesale"].map((x) => Wholesale.fromJson(x)))
            : [],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "choice_options": choice_options != null 
            ...
            : [],
        "colors": colors != null 
            ? List<dynamic>.from(colors!.map((x) => x))
            : [],
        "discount": discount,
